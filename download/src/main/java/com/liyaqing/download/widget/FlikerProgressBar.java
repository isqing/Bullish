package com.liyaqing.download.widget;
...
import com.liyaqing.download.utils.ScreenUtil;
...
//            pgCanvas.drawBitmap(flikerBitmap, flickerLeft, 0, pgPaint);
    ...
    private void drawProgressText(Canvas canvas) {
        ...
        float yCoordinate = (getMeasuredHeight() + tHeight  ) / 2- ScreenUtil.dip2px(2*borderWidth);
...
//        LogUtils.d("qing==getProgressText",text+","+Thread.currentThread().getName());
